                              ...
                              <div class="row" >
                                <div class="col-md-12">
                                    <div class="text-center" style=" padding: 10px; border: 2px solid; border-color: darkgrey; height: 130px" >
                                        <form method="post" action="<?php echo site_url('antrianpolikia/next') ?>">
                                            POLI KIA <br>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <?php
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    if (is_array($noantrikiad)) {
                                                        ...
                                                        <input type="hidden" name="idkunjunganumumd" class="form-control" type="hidden"  value="<?php echo $idkunjungan ?>">
                                                        <input type="hidden" class="text-center" type="text"  name="" value="<?php echo $noantrian; ?>" style="margin-bottom: 3px; width: 60px";>
                                                        <?php }
                                                    }else{?>
