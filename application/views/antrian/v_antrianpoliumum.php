                            ...
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="text-center" style=" padding: 10px; border: 2px solid; border-color: darkgrey; height: 130px" >
                                        <form method="post" action="<?php echo site_url('antrianpoliumum/next') ?>">
                                            POLI UMUM <br>
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <?php
                                                    if (is_array($noantriumumm)) {
                                                        ...
                                                        <input hidden="hidden" class="text-center" type="text"  name="" value="<?php echo $noantrian; ?>"" style="margin-bottom: 3px; width: 60px";>
                                                        <?php }
                                                    }else{?>
                                                     
                                                     <input hidden="hidden" class="text-center" type="text"  name="" value="0" style="margin-bottom: 3px; width: 60px";>
                                                    <?php  }?>
                                                </div>
                                                <div class="col-sm-4">
                                                    <?php
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    if (is_array($noantriumumd)) {
                                                        ...
                                                        <input hidden="hidden" name="idkunjunganumumd" class="form-control" type="hidden"  value="<?php echo $idkunjungan ?>">
                                                        <input hidden="hidden" class="text-center" type="text"  name="" value="<?php echo $noantrian; ?>" style="margin-bottom: 3px; width: 60px";>
                                                        <?php }
                                                    }else{?>
