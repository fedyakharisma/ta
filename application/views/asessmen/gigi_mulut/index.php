                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <center><label class="control-label col-xs-3">Muka</label></center>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="muka" value="Simetris">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="bengkak" value="Kiri">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="decay">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="failling">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="calculus">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    </div><i style="font-size: 90%;">*kosongi bila normal</i>
                                </div>
                                <div class="row">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="mukosa_mulut">
                                            </div>
                                        </div>
                                    </div><i style="font-size: 90%;">*kosongi bila normal</i>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="gingiva">
                                            </div>
                                        </div>
                                    </div><i style="font-size: 90%;">*kosongi bila normal</i>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <table class="table table-bordered table-responsive">
                                            <tr>
                                                <td><input name="gigi_susu_rahang_atas" value="55" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="54" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="53" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="52" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="51" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="61" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="62" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="63" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="64" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_atas" value="65" type="checkbox"></td>
                                            </tr>
                                            <tr align="center">
                                                <td>55</td>
                                                <td>54</td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <table class="table table-bordered table-responsive">
                                            <tr>
                                                <td><input name="rahang_atas" value="18" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="17" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="16" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="15" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="14" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="13" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="12" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="11" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="21" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="22" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="23" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="24" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="25" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="26" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="27" type="checkbox"></td>
                                                <td><input name="rahang_atas" value="28" type="checkbox"></td>
                                            </tr>
                                            <tr align="center">
                                                <td>18</td>
                                                <td>17</td>
                                            ...
                                            <tr>
                                                <td><input name="rahang_bawah" value="48" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="47" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="46" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="45" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="44" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="43" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="42" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="41" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="31" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="32" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="33" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="34" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="35" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="36" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="37" type="checkbox"></td>
                                                <td><input name="rahang_bawah" value="38" type="checkbox"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <table class="table table-bordered table-responsive">
                                            ...
                                            <tr align="center">
                                                <td><input name="gigi_susu_rahang_bawah" value="85" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="84" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="83" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="82" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="81" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="71" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="72" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="73" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="74" type="checkbox"></td>
                                                <td><input name="gigi_susu_rahang_bawah" value="75" type="checkbox"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
