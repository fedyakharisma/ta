            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Hasil Pemeriksaan Gigi dan Mulut</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo base_url('HasilPemeriksaan/cekGigiMulut/' . $data->id_asessmen_gigi_mulut); ?>">Cek</a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
