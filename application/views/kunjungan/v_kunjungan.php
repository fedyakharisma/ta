<div class="content-wrapper">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="<?php echo base_url('poliklinik/hapusPoliklinik/' . $data->no_rm) ?>" onclick="return confirm('Hapus <?php echo $data->no_rm ?>?/<?php echo $data->nama ?>?')" class="">
    ...
    foreach ($kunjungan as $data) {
        ...
        $no_rm = $data->no_rm;
        $nik_pangkat_nrp = $data->nip_ktp_nrp;
