                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><a href="<?php echo site_url('Soap/formGigiMulut/' . $data->id_asessmen_gigi_mulut) ?>" target="_blank" class="btn btn-primary col-sm-12">Lanjut Pemeriksaan <i class="nav-icon fas fa-arrow-right"></a></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
